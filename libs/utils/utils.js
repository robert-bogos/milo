...
`;
  document.body.appendChild(vaderDiv);
  const vaderStyle = document.createElement('style');
  vaderStyle.innerHTML = `
#vader-wrapper {
z-index: 999;
position: fixed;
top: 0;
...
`;
  document.head.appendChild(vaderStyle);
  hasVader = true;
}
// vader
